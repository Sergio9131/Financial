...
import { FinanceState, Income, Debt, Expense, ExpenseCategory, FinancialAlert, AdvancedStrategicPlan } from './types';
import { generateAdvancedStrategicPlan } from './strategy-engine';
...
const calculateSummary = (state: FinanceState): FinanceState => {
  ...
  // Generate advanced strategic plan
  const strategicPlan = generateAdvancedStrategicPlan(state.incomes, state.debts, state.expenses);
